...
private loadText() {
	if (location.timeZone || zipCode) {
		...
		log.debug "msg = ${msg}"
		state.sound = textToSpeechT(msg, true)
	}
	else {
		state.sound = textToSpeechT("Please set the location of your hub with the SmartThings mobile app, or enter a zip code to receive weather forecasts.")
	}
}
